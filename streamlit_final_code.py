...
from application import final_model
...
with st.form("Crop Predict"):          
    ...
    if submitted:
        try:
            ...
            with st.spinner(f'Loading . Do your know that :- {random.choice(final)}'):
            ...
            with col3:
                info_card("Rainfall", round(Rain*10,2), "🌧️", "mm/year") # Done to get the data back to original value earlier was scaled to 0.1
